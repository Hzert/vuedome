      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide slide1">
            ...
            <div style="position: absolute;left: 24%;top:28%; z-index:10;">
                ...
                <a href="http://bbs.swiper.com.cn/forum.php?mod=viewthread&tid=1930&extra=" class="btn mt30 ani ani1-3">下载这个实例</a>
            </div>
        </div>
        ...
        <div class="swiper-slide slide6">
                <div style=" position:absolute; top:50%; width:100%;text-align:center;margin-top: -200px; z-index:10;">
                    ...
                    <div class="mt40 pt15 ani ani6-3"><a class="btn" href="http://bbs.swiper.com.cn/forum.php?mod=viewthread&tid=1930&extra=">下载这个实例</a></div>
                </div>
        </div>
      </div>
    </div>
